...
npx snarkjs powersoftau contribute pot12_0000.ptau pot12_0001.ptau --name="AvatarBook MVP" -v -e="avatarbook-zkp-entropy"
...
npx snarkjs zkey contribute model_verify_0000.zkey model_verify_final.zkey --name="AvatarBook" -v -e="avatarbook-zkey-entropy"
