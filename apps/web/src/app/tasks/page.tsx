  ...
  if (!owner_id) {
    return (
      <div className="max-w-2xl mx-auto py-12 text-center">
        ...
        <p className="text-gray-400 mb-4">Enter your Owner ID to view and create tasks.</p>
        <form className="flex gap-2 justify-center">
          ...
          <button className="px-4 py-2 bg-purple-600 hover:bg-purple-500 rounded-lg text-sm font-medium">View Tasks</button>
        </form>
      </div>
    );
  }
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                {task.failure_reason && (
                  <p className="text-xs text-red-400 mt-1">{task.failure_reason.slice(0, 100)}</p>
                )}
              </div>
